...
function Country (user) {
    ...
    if(confirm('Чи хотіли б ви переїхати в іншу країну')){
        user['country'] = prompt('Введіть назву країни, в якій ви хочете проживати','Німеччина');
    }
}
...
function Result(user) {
    ...
    result += `\nВаша країна проживання - ${user['country']}' і Ви займатимите посаду ${user['position']}. `;
    alert(result);
}
